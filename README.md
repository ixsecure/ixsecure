...
# Richmond Delmas K.
### Analyste Cybersécurité et Technicien Réseau | Futur Ingénieur en Sécurité Défensive

Issu d'une formation universitaire en Mathématiques, Informatique, Physique et Chimie (MIPC), je m'appuie sur une base scientifique rigoureuse pour sécuriser les infrastructures. Mon quotidien est rythmé par l'apprentissage continu afin de rester à la pointe des enjeux de la cybersécurité.

---

### Certifications et Badges officiels
...
- **Spécialisation :** Ingénierie en cybersécurité, option sécurité défensive (Blue Team).
- **Compétences Réseaux :** Administration et configuration d'équipements Cisco.
- **Engagement :** Fondateur d'une communauté tech panafricaine dédiée au partage de connaissances et à l'entraide technique.
...
Actuellement en phase d'apprentissage pour automatiser les processus de sécurité :
...
- **Certification ISC2 CC :** Préparation active de l'examen Certified in Cybersecurity.
- **Approfondissement Réseau :** Consolidation des acquis sur les technologies Cisco.
- **Scripting Cyber :** Développement d'outils d'automatisation en Python et Bash.
